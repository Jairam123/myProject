...
<s:form action="complaintResolved" id="form"  name="search">
...
Enter text here...</textarea>
        ...
        <br>
                 ...
                 <s:submit method="resolved" cssClass="button" cssStyle="float:left;"  value="Resolve" id="resolve"/>
                 <s:submit method="escalate" cssClass="button"   value="Escalate" id="escalate"/>
</s:form>
<script src="Js/manager1.js"></script>
