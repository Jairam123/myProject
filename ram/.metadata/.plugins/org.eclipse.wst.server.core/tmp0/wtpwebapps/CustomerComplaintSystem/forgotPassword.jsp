...
<body>
	<div class="form">
		<div id="login">
			...
			<form action="forgotPassword" name="forgotPasswordForm">
				<div class="field-wrap">
					<label> Email Address<span class="req">*</span>
					</label> <input type="text" required autocomplete="off" name="email" id="email"/>
				</div>
				...
				<button class="button button-block" id="done">
				submit
				</button>
