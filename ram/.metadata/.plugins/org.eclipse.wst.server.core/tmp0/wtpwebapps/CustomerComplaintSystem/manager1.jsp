...
<div class="form">
     <h1>Complaints Search Form</h1>
       <div id="signup">
          <form action="managerSearchResult" method="post" id="managerForm">
           <div class="field-wrap">
               <label style="margin-left:-10px;">Customer Name</label>
               <br>
               <br>
              <sx:autocompleter id="name" list="complainersList" name="customerName" showDownArrow="false" cssStyle="width:100%;" ></sx:autocompleter>
            </div>
         ...
         <div class="field-wrap" style="margin-top:-15px;">
            ...
            <br>
            <br>
            <input type="text" autocomplete="off" id="mobileNumber" name="mobileNumber"/>
          </div>
          <div class="field-wrap" style="margin-top:-15px;">
            <label style="margin-left:-10px;">
